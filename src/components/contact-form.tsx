...
import { Send, Mail, Linkedin, Github, Clock, CheckCircle, Phone, AlertCircle, MessageCircle } from "lucide-react"
          ...
          <aside className="lg:col-span-2 space-y-8" aria-label="Contact information">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="group flex items-center gap-4 p-4 rounded-xl glass border border-transparent hover:border-primary/30 transition-all duration-300"
                aria-label="Message Madan Rajendra on WhatsApp"
              >
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                  <MessageCircle className="w-5 h-5 text-primary" aria-hidden="true" />
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">WhatsApp Inquiry</p>
              ...
              >
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Direct Call</p>
                  <p className="text-foreground font-medium">+91 9535318620</p>
                </div>
              </a>
