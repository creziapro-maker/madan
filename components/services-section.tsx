...
const services: Service[] = [
  {
    ...
    description: "I build Flutter apps that don't just work—they feel right. From smooth animations to intuitive navigation, I focus on the details that users notice.",
  ...
  },
  {
    icon: Brain,
    title: "Practical AI",
    description: "AI shouldn't be a buzzword. I help you integrate LLMs and smart features that actually add value to your product and save users time.",
  ...
  },
  {
    ...
    description: "I set up Firebase and cloud systems that handle the heavy lifting, so you can focus on growing your business without worrying about the tech.",
  ...
  },
  {
    ...
    description: "From the first line of code to the final deployment, I handle the full stack to ensure your product is cohesive and well-architected.",
  ...
  },
  {
    ...
    description: "Need to move fast? I help founders go from idea to MVP in record time, building a foundation that's ready to scale when you are.",
  ...
  },
  {
    ...
    description: "I build internal tools and code generators that automate the boring stuff, letting your team focus on what they do best.",
