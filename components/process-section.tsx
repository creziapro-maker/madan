...
const steps: ProcessStep[] = [
  {
    icon: Lightbulb,
    title: "Brainstorming & Coffee",
    description: "We start by talking through your vision. I want to understand not just what we're building, but why it matters to your users.",
    number: "01",
  ...
  },
  {
    ...
    description: "I get to work setting up the core architecture. No cutting corners—I build with scalability and clean Flutter/Firebase patterns from day one.",
    number: "02",
  ...
  },
  {
    ...
    description: "I don't disappear for weeks. You'll see regular progress, and we'll iterate together to make sure every pixel and interaction feels right.",
    number: "03",
  ...
  {
    icon: CheckCircle,
    title: "Polishing to Perfection",
    description: "Testing, squashing bugs, and fine-tuning animations. I make sure the app isn't just functional, but a joy to use.",
    number: "04",
  ...
  },
  {
    ...
    description: "I help you get onto the App Store/Play Store and stick around to make sure everything runs smoothly as your user base grows.",
    number: "05",
